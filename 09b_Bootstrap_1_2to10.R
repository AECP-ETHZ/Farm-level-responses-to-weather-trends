#----------------------------------------------------#
#                                                    #
# This program estimates the model with 1 and 2to10  #
...
# stored in lines 918 and 933, allowing to           # 
...
df_farm <- df_farm %>% select(key, year, nuts2, 
                              ...
                              gdd_1, prec_1, gddHigh_1, dd_1, 
                              gdd_2to10, prec_2to10, gddHigh_2to10, dd_2to10,
                              ...
                              gdd_1_fm, prec_1_fm, gddHigh_1_fm, dd_1_fm, 
                              gdd_2to10_fm, prec_2to10_fm, gddHigh_2to10_fm, dd_2to10_fm,
                              qq_cereals, qq_protein, qq_oilseed, qq_roots, qq_corn, nx_fert, x_fert, x_otherinp,
                              gdd_obs, prec_obs, gddHigh_obs, dd_obs,
                              gdd_obs_1, prec_obs_1, gddHigh_obs_1, dd_obs_1,
                              gdd_obs_2to10, prec_obs_2to10, gddHigh_obs_2to10, dd_obs_2to10,
                              gdd_obs_fm, prec_obs_fm, gddHigh_obs_fm, dd_obs_fm,
                              gdd_obs_1_fm, prec_obs_1_fm, gddHigh_obs_1_fm, dd_obs_1_fm,
                              gdd_obs_2to10_fm, prec_obs_2to10_fm, gddHigh_obs_2to10_fm, dd_obs_2to10_fm)
...
my.boot <- function(data, nrep, cluster, nCores, actual) {
  ...
  #Define structural equations
    ...
    eqQQcereals <- qq_cereals ~ PHI_cereals + I(PHI_cereals*np_cereals) + I(PHI_cereals*np_protein) + I(PHI_cereals*np_oilseed) + I(PHI_cereals*np_roots) + I(PHI_cereals*np_corn) + I(PHI_cereals*nw_fert) + 
      ...
      I(PHI_cereals*gdd_1) + I(PHI_cereals*prec_1) + I(PHI_cereals*gddHigh_1) + I(PHI_cereals*dd_1) +
      I(PHI_cereals*gdd_2to10) + I(PHI_cereals*prec_2to10) + I(PHI_cereals*gddHigh_2to10) + I(PHI_cereals*dd_2to10) +
      I(PHI_cereals*gdd_obs_1) + I(PHI_cereals*prec_obs_1) + I(PHI_cereals*gddHigh_obs_1) + I(PHI_cereals*dd_obs_1) + 
      I(PHI_cereals*gdd_obs_2to10) + I(PHI_cereals*prec_obs_2to10) + I(PHI_cereals*gddHigh_obs_2to10) + I(PHI_cereals*dd_obs_2to10) + 
      ...
      I(PHI_cereals*gdd_1_fm) + I(PHI_cereals*prec_1_fm) + I(PHI_cereals*gddHigh_1_fm) + I(PHI_cereals*dd_1_fm) +
      I(PHI_cereals*gdd_2to10_fm) + I(PHI_cereals*prec_2to10_fm) + I(PHI_cereals*gddHigh_2to10_fm) + I(PHI_cereals*dd_2to10_fm) + 
      I(PHI_cereals*gdd_obs_1_fm) + I(PHI_cereals*prec_obs_1_fm) + I(PHI_cereals*gddHigh_obs_1_fm) + I(PHI_cereals*dd_obs_1_fm) + 
      I(PHI_cereals*gdd_obs_2to10_fm) + I(PHI_cereals*prec_obs_2to10_fm) + I(PHI_cereals*gddHigh_obs_2to10_fm) + I(PHI_cereals*dd_obs_2to10_fm) + 
      phi_cereals -1
    eqQQprotein <- qq_protein ~ PHI_protein + I(PHI_protein*np_cereals) + I(PHI_protein*np_protein) + I(PHI_protein*np_oilseed) + I(PHI_protein*np_roots) + I(PHI_protein*np_corn) + I(PHI_protein*nw_fert) + 
      ...
      I(PHI_protein*gdd_1) + I(PHI_protein*prec_1) + I(PHI_protein*gddHigh_1) + I(PHI_protein*dd_1) +
      I(PHI_protein*gdd_2to10) + I(PHI_protein*prec_2to10) + I(PHI_protein*gddHigh_2to10) + I(PHI_protein*dd_2to10) +
      I(PHI_protein*gdd_obs_1) + I(PHI_protein*prec_obs_1) + I(PHI_protein*gddHigh_obs_1) + I(PHI_protein*dd_obs_1) + 
      I(PHI_protein*gdd_obs_2to10) + I(PHI_protein*prec_obs_2to10) + I(PHI_protein*gddHigh_obs_2to10) + I(PHI_protein*dd_obs_2to10) + 
      ...
      I(PHI_protein*gdd_1_fm) + I(PHI_protein*prec_1_fm) + I(PHI_protein*gddHigh_1_fm) + I(PHI_protein*dd_1_fm) +
      I(PHI_protein*gdd_2to10_fm) + I(PHI_protein*prec_2to10_fm) + I(PHI_protein*gddHigh_2to10_fm) + I(PHI_protein*dd_2to10_fm) + 
      I(PHI_protein*gdd_obs_1_fm) + I(PHI_protein*prec_obs_1_fm) + I(PHI_protein*gddHigh_obs_1_fm) + I(PHI_protein*dd_obs_1_fm) + 
      I(PHI_protein*gdd_obs_2to10_fm) + I(PHI_protein*prec_obs_2to10_fm) + I(PHI_protein*gddHigh_obs_2to10_fm) + I(PHI_protein*dd_obs_2to10_fm) + 
      phi_protein -1
    eqQQoilseed <- qq_oilseed ~ PHI_oilseed + I(PHI_oilseed*np_cereals) + I(PHI_oilseed*np_protein) + I(PHI_oilseed*np_oilseed) + I(PHI_oilseed*np_roots) + I(PHI_oilseed*np_corn) + I(PHI_oilseed*nw_fert) + 
      ...
      I(PHI_oilseed*gdd_1) + I(PHI_oilseed*prec_1) + I(PHI_oilseed*gddHigh_1) + I(PHI_oilseed*dd_1) +
      I(PHI_oilseed*gdd_2to10) + I(PHI_oilseed*prec_2to10) + I(PHI_oilseed*gddHigh_2to10) + I(PHI_oilseed*dd_2to10) +
      I(PHI_oilseed*gdd_obs_1) + I(PHI_oilseed*prec_obs_1) + I(PHI_oilseed*gddHigh_obs_1) + I(PHI_oilseed*dd_obs_1) + 
      I(PHI_oilseed*gdd_obs_2to10) + I(PHI_oilseed*prec_obs_2to10) + I(PHI_oilseed*gddHigh_obs_2to10) + I(PHI_oilseed*dd_obs_2to10) + 
      ...
      I(PHI_oilseed*gdd_1_fm) + I(PHI_oilseed*prec_1_fm) + I(PHI_oilseed*gddHigh_1_fm) + I(PHI_oilseed*dd_1_fm) +
      I(PHI_oilseed*gdd_2to10_fm) + I(PHI_oilseed*prec_2to10_fm) + I(PHI_oilseed*gddHigh_2to10_fm) + I(PHI_oilseed*dd_2to10_fm) + 
      I(PHI_oilseed*gdd_obs_1_fm) + I(PHI_oilseed*prec_obs_1_fm) + I(PHI_oilseed*gddHigh_obs_1_fm) + I(PHI_oilseed*dd_obs_1_fm) + 
      I(PHI_oilseed*gdd_obs_2to10_fm) + I(PHI_oilseed*prec_obs_2to10_fm) + I(PHI_oilseed*gddHigh_obs_2to10_fm) + I(PHI_oilseed*dd_obs_2to10_fm) + 
      phi_oilseed -1
    eqQQroots <- qq_roots ~ PHI_roots + I(PHI_roots*np_cereals) + I(PHI_roots*np_protein) + I(PHI_roots*np_oilseed) + I(PHI_roots*np_roots) + I(PHI_roots*np_corn) + I(PHI_roots*nw_fert) + 
      ...
      I(PHI_roots*gdd_1) + I(PHI_roots*prec_1) + I(PHI_roots*gddHigh_1) + I(PHI_roots*dd_1) +
      I(PHI_roots*gdd_2to10) + I(PHI_roots*prec_2to10) + I(PHI_roots*gddHigh_2to10) + I(PHI_roots*dd_2to10) +
      I(PHI_roots*gdd_obs_1) + I(PHI_roots*prec_obs_1) + I(PHI_roots*gddHigh_obs_1) + I(PHI_roots*dd_obs_1) + 
      I(PHI_roots*gdd_obs_2to10) + I(PHI_roots*prec_obs_2to10) + I(PHI_roots*gddHigh_obs_2to10) + I(PHI_roots*dd_obs_2to10) + 
      ...
      I(PHI_roots*gdd_1_fm) + I(PHI_roots*prec_1_fm) + I(PHI_roots*gddHigh_1_fm) + I(PHI_roots*dd_1_fm) +
      I(PHI_roots*gdd_2to10_fm) + I(PHI_roots*prec_2to10_fm) + I(PHI_roots*gddHigh_2to10_fm) + I(PHI_roots*dd_2to10_fm) +
      I(PHI_roots*gdd_obs_1_fm) + I(PHI_roots*prec_obs_1_fm) + I(PHI_roots*gddHigh_obs_1_fm) + I(PHI_roots*dd_obs_1_fm) + 
      I(PHI_roots*gdd_obs_2to10_fm) + I(PHI_roots*prec_obs_2to10_fm) + I(PHI_roots*gddHigh_obs_2to10_fm) + I(PHI_roots*dd_obs_2to10_fm) + 
      phi_roots -1
    eqQQcorn <- qq_corn ~ PHI_corn + I(PHI_corn*np_cereals) + I(PHI_corn*np_protein) + I(PHI_corn*np_oilseed) + I(PHI_corn*np_roots) + I(PHI_corn*np_corn) + I(PHI_corn*nw_fert) + 
      ...
      I(PHI_corn*gdd_1) + I(PHI_corn*prec_1) + I(PHI_corn*gddHigh_1) + I(PHI_corn*dd_1) +
      I(PHI_corn*gdd_2to10) + I(PHI_corn*prec_2to10) + I(PHI_corn*gddHigh_2to10) + I(PHI_corn*dd_2to10) +
      I(PHI_corn*gdd_obs_1) + I(PHI_corn*prec_obs_1) + I(PHI_corn*gddHigh_obs_1) + I(PHI_corn*dd_obs_1) + 
      I(PHI_corn*gdd_obs_2to10) + I(PHI_corn*prec_obs_2to10) + I(PHI_corn*gddHigh_obs_2to10) + I(PHI_corn*dd_obs_2to10) + 
      ...
      I(PHI_corn*gdd_1_fm) + I(PHI_corn*prec_1_fm) + I(PHI_corn*gddHigh_1_fm) + I(PHI_corn*dd_1_fm) +
      I(PHI_corn*gdd_2to10_fm) + I(PHI_corn*prec_2to10_fm) + I(PHI_corn*gddHigh_2to10_fm) + I(PHI_corn*dd_2to10_fm) +
      I(PHI_corn*gdd_obs_1_fm) + I(PHI_corn*prec_obs_1_fm) + I(PHI_corn*gddHigh_obs_1_fm) + I(PHI_corn*dd_obs_1_fm) + 
      I(PHI_corn*gdd_obs_2to10_fm) + I(PHI_corn*prec_obs_2to10_fm) + I(PHI_corn*gddHigh_obs_2to10_fm) + I(PHI_corn*dd_obs_2to10_fm) + 
      phi_corn -1
...
#----------------------------------------#
  ...
  # ---------------------------------- #  
    ...
    list_weather <- data.frame(weather_obs=  c("gdd_obs","prec_obs","gddHigh_obs","dd_obs"),
                               weather_1= c("gdd_1","prec_1","gddHigh_1","dd_1"),
                               weather_2to10=c("gdd_2to10","prec_2to10","gddHigh_2to10","dd_2to10"),
                               weather_obs_1 = c("gdd_obs_1","prec_obs_1","gddHigh_obs_1","dd_obs_1"),
                               weather_obs_2to10 = c("gdd_obs_2to10","prec_obs_2to10","gddHigh_obs_2to10","dd_obs_2to10"),
                               weather_obs_endwith=  c("* gdd_obs)","* prec_obs)","* gddHigh_obs)","* dd_obs)"),
                               weather_1_endwith= c("* gdd_1)","* prec_1)","* gddHigh_1)","* dd_1)"),
                               weather_2to10_endwith=c("* gdd_2to10)","* prec_2to10)","* gddHigh_2to10)","* dd_2to10)"),
                               weather_obs_1_endwith = c("* gdd_obs_1)","* prec_obs_1)","* gddHigh_obs_1)","* dd_obs_1)"),
                               weather_obs_2to10_endwith = c("* gdd_obs_2to10)","* prec_obs_2to10)","* gddHigh_obs_2to10)","* dd_obs_2to10)"))
    ...
    for (i in 1:n_qcrops) { 
      ...
      for (j in 1:n_weather) {
        ...
        coef_struct_weather_obs_1 <- coefs_struct_crop %>% select(ends_with(list_weather[j,"weather_obs_1_endwith"]))
        coef_struct_weather_obs_2to10 <- coefs_struct_crop %>% select(ends_with(list_weather[j,"weather_obs_2to10_endwith"]))
        
        # Mean weather for derivatives 
        mean_weather_obs <- dat_sm %>% select(list_weather[j,"weather_obs"])
        mean_weather_1 <- dat_sm %>% select(list_weather[j,"weather_1"])
        mean_weather_2to10 <- dat_sm %>% select(list_weather[j,"weather_2to10"])
        ...
        elast_weather[j,i+1] <- PHI * (coef_struct_weather + coef_struct_weather_obs_1*mean_weather_1 + coef_struct_weather_obs_2to10*mean_weather_2to10)  * (1/mean_quantity)
        
        # Weather_1
        coef_probit_weather <- coefs_probit_crop %>% select(list_weather[j,"weather_1"])
        coef_struct_weather <- coefs_struct_crop %>% select(ends_with(list_weather[j,"weather_1_endwith"]))
        
        elast_weather_1 <- (PHI * (coef_struct_weather + coef_struct_weather_obs_1*mean_weather_obs) + phi * pred * coef_probit_weather -
                              coef_phi_struct * linpred * coef_probit_weather * phi) * (1 / mean_quantity )
        
        # Weather_2to10
        coef_probit_weather <- coefs_probit_crop %>% select(list_weather[j,"weather_2to10"])
        coef_struct_weather <- coefs_struct_crop %>% select(ends_with(list_weather[j,"weather_2to10_endwith"]))
        
        elast_weather_2to10 <- (PHI * (coef_struct_weather + coef_struct_weather_obs_2to10*mean_weather_obs) + phi * pred * coef_probit_weather -
                                  coef_phi_struct * linpred * coef_probit_weather * phi) * (1 / mean_quantity )
        
        # Weather_past
        elast_weather[j+4,i+1] <- elast_weather_1 + elast_weather_2to10
    ...
    list_weather <- data.frame(weather_obs=  c("gdd_obs","prec_obs","gddHigh_obs","dd_obs"),
                               ...
                               weather_1_endwith= c("_gdd_1","_prec_1","_gddHigh_1","_dd_1"),
                               weather_2to10_endwith=c("_gdd_2to10","_prec_2to10","_gddHigh_2to10","_dd_2to10"),
                               weather_obs_1_endwith = c("_gdd_obs_1","_prec_obs_1","_gddHigh_obs_1","_dd_obs_1"),
                               weather_obs_2to10_endwith = c("_gdd_obs_2to10","_prec_obs_2to10","_gddHigh_obs_2to10","_dd_obs_2to10"))
    ...
    for (j in 1:n_weather) {
      ...
      # Weather-interaction terms
      coef_fert_weather_obs_1 <- coefs_fert %>% select(ends_with(list_weather[j,"weather_obs_1_endwith"]))
      coef_fert_weather_obs_2to10 <- coefs_fert %>% select(ends_with(list_weather[j,"weather_obs_2to10_endwith"]))
      ...
      elast_weather[j,7] <- (coef_fert_weather + coef_fert_weather_obs_1*mean_weather_1 + coef_fert_weather_obs_2to10*mean_weather_2to10) * (1/dat_sm$nx_fert)
      
      # Weather_1
      coef_fert_weather <- coefs_fert %>% select(ends_with(list_weather[j,"weather_1_endwith"]))
      elast_weather_1 <- (coef_fert_weather + coef_fert_weather_obs_1*mean_weather_obs) * (1/dat_sm$nx_fert)
      
      # Weather_2to10
      coef_fert_weather <- coefs_fert %>% select(ends_with(list_weather[j,"weather_2to10_endwith"]))
      elast_weather_2to10 <- (coef_fert_weather + coef_fert_weather_obs_2to10*mean_weather_obs) * (1/dat_sm$nx_fert)
      
      # Weather_past
      elast_weather[j+4,7] <- elast_weather_1 + elast_weather_2to10
...
# save actual result
save(boot_actresults, file="rOutput/bootresults_1_2to10_actual.Rda")
...
# save
save(boot_results, file="rOutput/bootresults_1_2to10.Rda")
boot_results <- NULL
...
load("rOutput/bootresults_1_2to10.Rda")
load("rOutput/bootresults_1_2to10_actual.Rda")
...
# Print
write_xlsx(tab_parprobit, "Tables/Table_S6.3.1.xlsx")
...
tab_structural$Variable <- c("Intercept", "P Cereals", "P Protein", "P Oilseed crops", "P Root crops", "P Corn", "R Fert", 
                             ...
                             "Gdd_1", "Prec_1", "GddHigh_1", "DD_1",
                             "Gdd_2to10", "Prec_2to10", "GddHigh_2to10", "DD_2to10",
                             "Gdd x Gdd_1", "Prec x Prec_1", "GddHigh x GddHigh_1", "DD x DD_1",
                             "Gdd x Gdd_2to10", "Prec x Prec_2to10", "GddHigh x GddHigh_2to10", "DD x DD_2to10",
                             "phi Cereals",
...
# Print
write_xlsx(tab_structural, "Tables/Table_S6.3.2.xlsx")
...
# Print
write_xlsx(tab_PriceElast, "Tables/Table_S6.3.3.xlsx")
...
# Print
write_xlsx(tab_WeatherElast, "Tables/Table_S6.3.4.xlsx")
