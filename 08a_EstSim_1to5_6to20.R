...
# 2018-drought, for the model with 1to5 and 6to20 lags. #
#                                                       #
# Note: The farm-level data are confidential and cannot # 
# be loaded (line 17). The results at the sample mean   #
# are saved in line 514 and the figure in Section 5     # 
# can be created.                                       #
#                                                       #
#-------------------------------------------------------#
...
# Load simulated weather
  ...
  load("rOutput/sim2018_1to5_6to20.Rda")
  sim2018 <- sim2018_1to5_6to20
...
# Add observed weather to simulated weather
  ...
  sim2018$gdd_obs <- c(df_weather_lta$gdd_1030, df_weather_2018$gdd_1030, rep(df_weather_lta$gdd_1030,20))
  sim2018$prec_obs <- c(df_weather_lta$prec, df_weather_2018$prec, rep(df_weather_lta$prec,20))
  sim2018$gddHigh_obs <- c(df_weather_lta$gdd_30, df_weather_2018$gdd_30, rep(df_weather_lta$gdd_30,20))
  sim2018$dd_obs <- c(df_weather_lta$dd, df_weather_2018$dd, rep(df_weather_lta$dd,20))
  
# Add interactions between observed and experienced weather
  
  sim2018$gdd_obs_1to5     <- sim2018$gdd_obs * sim2018$gdd_1to5
  sim2018$prec_obs_1to5    <- sim2018$prec_obs * sim2018$prec_1to5
  sim2018$gddHigh_obs_1to5 <- sim2018$gddHigh_obs * sim2018$gddHigh_1to5
  sim2018$dd_obs_1to5          <- sim2018$dd_obs * sim2018$dd_1to5
  
  sim2018$gdd_obs_6to20     <- sim2018$gdd_obs * sim2018$gdd_6to20
  sim2018$prec_obs_6to20    <- sim2018$prec_obs * sim2018$prec_6to20
  sim2018$gddHigh_obs_6to20 <- sim2018$gddHigh_obs * sim2018$gddHigh_6to20
  sim2018$dd_obs_6to20          <- sim2018$dd_obs * sim2018$dd_6to20
...
cereal.eq <- iCereals ~ np_cereals + np_protein + np_oilseed + np_roots + np_corn + nw_fert + 
  ...
  gdd_6to20 + prec_6to20 + gddHigh_6to20 + dd_6to20 +
  ...
  gdd_6to20_fm + prec_6to20_fm + gddHigh_6to20_fm + dd_6to20_fm
...
for (i in 1:n_crops) { 
  ...
  # Simulation
      ...
      for (t in -1:20)
      {
        ...
        # Simulate t = -1
        X$gdd_1to5 <- sim2018$gdd_1to5[sim2018$t==t]
        X$prec_1to5 <- sim2018$prec_1to5[sim2018$t==t]
        X$gddHigh_1to5 <- sim2018$gddHigh_1to5[sim2018$t==t]
        X$dd_1to5 <- sim2018$dd_1to5[sim2018$t==t]
        X$gdd_6to20 <- sim2018$gdd_6to20[sim2018$t==t]
        X$prec_6to20 <- sim2018$prec_6to20[sim2018$t==t]
        X$gddHigh_6to20 <- sim2018$gddHigh_6to20[sim2018$t==t]
        X$dd_6to20  <- sim2018$dd_6to20[sim2018$t==t]
...
eqQQcereals <- qq_cereals ~ PHI_cereals + I(PHI_cereals*np_cereals) + I(PHI_cereals*np_protein) + I(PHI_cereals*np_oilseed) + I(PHI_cereals*np_roots) + I(PHI_cereals*np_corn) + I(PHI_cereals*nw_fert) + 
  ...
  I(PHI_cereals*gdd_6to20) + I(PHI_cereals*prec_6to20) + I(PHI_cereals*gddHigh_6to20) + I(PHI_cereals*dd_6to20) +
  I(PHI_cereals*gdd_obs_1to5) + I(PHI_cereals*prec_obs_1to5) + I(PHI_cereals*gddHigh_obs_1to5) + I(PHI_cereals*dd_obs_1to5) + 
  I(PHI_cereals*gdd_obs_6to20) + I(PHI_cereals*prec_obs_6to20) + I(PHI_cereals*gddHigh_obs_6to20) + I(PHI_cereals*dd_obs_6to20) + 
  ...
  I(PHI_cereals*gdd_6to20_fm) + I(PHI_cereals*prec_6to20_fm) + I(PHI_cereals*gddHigh_6to20_fm) + I(PHI_cereals*dd_6to20_fm) + 
  ...
  I(PHI_cereals*gdd_obs_6to20_fm) + I(PHI_cereals*prec_obs_6to20_fm) + I(PHI_cereals*gddHigh_obs_6to20_fm) + I(PHI_cereals*dd_obs_6to20_fm) + 
  phi_cereals -1
eqQQprotein <- qq_protein ~ PHI_protein + I(PHI_protein*np_cereals) + I(PHI_protein*np_protein) + I(PHI_protein*np_oilseed) + I(PHI_protein*np_roots) + I(PHI_protein*np_corn) + I(PHI_protein*nw_fert) + 
  ...
  I(PHI_protein*gdd_6to20) + I(PHI_protein*prec_6to20) + I(PHI_protein*gddHigh_6to20) + I(PHI_protein*dd_6to20) +
  I(PHI_protein*gdd_obs_1to5) + I(PHI_protein*prec_obs_1to5) + I(PHI_protein*gddHigh_obs_1to5) + I(PHI_protein*dd_obs_1to5) + 
  I(PHI_protein*gdd_obs_6to20) + I(PHI_protein*prec_obs_6to20) + I(PHI_protein*gddHigh_obs_6to20) + I(PHI_protein*dd_obs_6to20) + 
  ...
  I(PHI_protein*gdd_6to20_fm) + I(PHI_protein*prec_6to20_fm) + I(PHI_protein*gddHigh_6to20_fm) + I(PHI_protein*dd_6to20_fm) + 
  ...
  I(PHI_protein*gdd_obs_6to20_fm) + I(PHI_protein*prec_obs_6to20_fm) + I(PHI_protein*gddHigh_obs_6to20_fm) + I(PHI_protein*dd_obs_6to20_fm) + 
  phi_protein -1
eqQQoilseed <- qq_oilseed ~ PHI_oilseed + I(PHI_oilseed*np_cereals) + I(PHI_oilseed*np_protein) + I(PHI_oilseed*np_oilseed) + I(PHI_oilseed*np_roots) + I(PHI_oilseed*np_corn) + I(PHI_oilseed*nw_fert) + 
  ...
  I(PHI_oilseed*gdd_6to20) + I(PHI_oilseed*prec_6to20) + I(PHI_oilseed*gddHigh_6to20) + I(PHI_oilseed*dd_6to20) +
  I(PHI_oilseed*gdd_obs_1to5) + I(PHI_oilseed*prec_obs_1to5) + I(PHI_oilseed*gddHigh_obs_1to5) + I(PHI_oilseed*dd_obs_1to5) + 
  I(PHI_oilseed*gdd_obs_6to20) + I(PHI_oilseed*prec_obs_6to20) + I(PHI_oilseed*gddHigh_obs_6to20) + I(PHI_oilseed*dd_obs_6to20) + 
  ...
  I(PHI_oilseed*gdd_6to20_fm) + I(PHI_oilseed*prec_6to20_fm) + I(PHI_oilseed*gddHigh_6to20_fm) + I(PHI_oilseed*dd_6to20_fm) + 
  ...
  I(PHI_oilseed*gdd_obs_6to20_fm) + I(PHI_oilseed*prec_obs_6to20_fm) + I(PHI_oilseed*gddHigh_obs_6to20_fm) + I(PHI_oilseed*dd_obs_6to20_fm) + 
  phi_oilseed -1
eqQQroots <- qq_roots ~ PHI_roots + I(PHI_roots*np_cereals) + I(PHI_roots*np_protein) + I(PHI_roots*np_oilseed) + I(PHI_roots*np_roots) + I(PHI_roots*np_corn) + I(PHI_roots*nw_fert) + 
  ...
  I(PHI_roots*gdd_6to20) + I(PHI_roots*prec_6to20) + I(PHI_roots*gddHigh_6to20) + I(PHI_roots*dd_6to20) +
  I(PHI_roots*gdd_obs_1to5) + I(PHI_roots*prec_obs_1to5) + I(PHI_roots*gddHigh_obs_1to5) + I(PHI_roots*dd_obs_1to5) + 
  I(PHI_roots*gdd_obs_6to20) + I(PHI_roots*prec_obs_6to20) + I(PHI_roots*gddHigh_obs_6to20) + I(PHI_roots*dd_obs_6to20) + 
  ...
  I(PHI_roots*gdd_6to20_fm) + I(PHI_roots*prec_6to20_fm) + I(PHI_roots*gddHigh_6to20_fm) + I(PHI_roots*dd_6to20_fm) +
  I(PHI_roots*gdd_obs_1to5_fm) + I(PHI_roots*prec_obs_1to5_fm) + I(PHI_roots*gddHigh_obs_1to5_fm) + I(PHI_roots*dd_obs_1to5_fm) + 
  I(PHI_roots*gdd_obs_6to20_fm) + I(PHI_roots*prec_obs_6to20_fm) + I(PHI_roots*gddHigh_obs_6to20_fm) + I(PHI_roots*dd_obs_6to20_fm) + 
  phi_roots -1
eqQQcorn <- qq_corn ~ PHI_corn + I(PHI_corn*np_cereals) + I(PHI_corn*np_protein) + I(PHI_corn*np_oilseed) + I(PHI_corn*np_roots) + I(PHI_corn*np_corn) + I(PHI_corn*nw_fert) + 
  ...
  I(PHI_corn*gdd_6to20) + I(PHI_corn*prec_6to20) + I(PHI_corn*gddHigh_6to20) + I(PHI_corn*dd_6to20) +
  I(PHI_corn*gdd_obs_1to5) + I(PHI_corn*prec_obs_1to5) + I(PHI_corn*gddHigh_obs_1to5) + I(PHI_corn*dd_obs_1to5) + 
  I(PHI_corn*gdd_obs_6to20) + I(PHI_corn*prec_obs_6to20) + I(PHI_corn*gddHigh_obs_6to20) + I(PHI_corn*dd_obs_6to20) + 
  ...
  I(PHI_corn*gdd_6to20_fm) + I(PHI_corn*prec_6to20_fm) + I(PHI_corn*gddHigh_6to20_fm) + I(PHI_corn*dd_6to20_fm) +
  I(PHI_corn*gdd_obs_1to5_fm) + I(PHI_corn*prec_obs_1to5_fm) + I(PHI_corn*gddHigh_obs_1to5_fm) + I(PHI_corn*dd_obs_1to5_fm) + 
  I(PHI_corn*gdd_obs_6to20_fm) + I(PHI_corn*prec_obs_6to20_fm) + I(PHI_corn*gddHigh_obs_6to20_fm) + I(PHI_corn*dd_obs_6to20_fm) + 
  phi_corn -1
eqNXfert <- nx_fert ~ np_cereals + np_protein + np_oilseed + np_roots + np_corn + nw_fert + 
  ...
  gdd_obs_6to20 + prec_obs_6to20 + gddHigh_obs_6to20 + dd_obs_6to20 + 
  np_cereals_fm + np_protein_fm + np_oilseed_fm + np_roots_fm + np_corn_fm + nw_fert_fm +
  k_land_fm + k_labor_fm + k_capital_fm + trend_fm + trend2_fm + 
  ...
  gdd_obs_6to20_fm + prec_obs_6to20_fm + gddHigh_obs_6to20_fm + dd_obs_6to20_fm
...
# ------------------------------------ #
  ...
  for (i in 1:n_outcomes) { 
    ...
    for (t in -1:20) {
      ...
      X_sim$gdd_1to5 <- sim2018$gdd_1to5[sim2018$t==t]
      X_sim$prec_1to5 <- sim2018$prec_1to5[sim2018$t==t]
      X_sim$gddHigh_1to5 <- sim2018$gddHigh_1to5[sim2018$t==t]
      X_sim$dd_1to5 <- sim2018$dd_1to5[sim2018$t==t]
          
      X_sim$gdd_6to20 <- sim2018$gdd_6to20[sim2018$t==t]
      X_sim$prec_6to20 <- sim2018$prec_6to20[sim2018$t==t]
      X_sim$gddHigh_6to20 <- sim2018$gddHigh_6to20[sim2018$t==t]
      X_sim$dd_6to20  <- sim2018$dd_6to20[sim2018$t==t]
            
      X_sim$gdd_obs_1to5 <- sim2018$gdd_obs_1to5[sim2018$t==t]
      X_sim$prec_obs_1to5 <- sim2018$prec_obs_1to5[sim2018$t==t]
      X_sim$gddHigh_obs_1to5 <- sim2018$gddHigh_obs_1to5[sim2018$t==t]
      X_sim$dd_obs_1to5 <- sim2018$dd_obs_1to5[sim2018$t==t]
      X_sim$gdd_obs_6to20 <- sim2018$gdd_obs_6to20[sim2018$t==t]
      X_sim$prec_obs_6to20 <- sim2018$prec_obs_6to20[sim2018$t==t]
      X_sim$gddHigh_obs_6to20 <- sim2018$gddHigh_obs_6to20[sim2018$t==t]
      X_sim$dd_obs_6to20 <- sim2018$dd_obs_6to20[sim2018$t==t]
  ...
  simresults <- data.frame(
    ...
    Cereals = c(mean(list_simresults$Cereals$t1), mean(list_simresults$Cereals$t2), mean(list_simresults$Cereals$t3),
                ...
                mean(list_simresults$Cereals$t13), mean(list_simresults$Cereals$t14), mean(list_simresults$Cereals$t15),
                mean(list_simresults$Cereals$t16), mean(list_simresults$Cereals$t17), mean(list_simresults$Cereals$t18),
                mean(list_simresults$Cereals$t19), mean(list_simresults$Cereals$t20), mean(list_simresults$Cereals$t21),
                mean(list_simresults$Cereals$t22)),
    Protein = c(mean(list_simresults$Protein$t1), mean(list_simresults$Protein$t2), mean(list_simresults$Protein$t3),
                ...
                mean(list_simresults$Protein$t13), mean(list_simresults$Protein$t14), mean(list_simresults$Protein$t15),
                mean(list_simresults$Protein$t16), mean(list_simresults$Protein$t17), mean(list_simresults$Protein$t18),
                mean(list_simresults$Protein$t19), mean(list_simresults$Protein$t20), mean(list_simresults$Protein$t21),
                mean(list_simresults$Protein$t22)),
    Oilseed = c(mean(list_simresults$Oilseed$t1), mean(list_simresults$Oilseed$t2), mean(list_simresults$Oilseed$t3),
                ...
                mean(list_simresults$Oilseed$t13), mean(list_simresults$Oilseed$t14), mean(list_simresults$Oilseed$t15),
                mean(list_simresults$Oilseed$t16), mean(list_simresults$Oilseed$t17), mean(list_simresults$Oilseed$t18),
                mean(list_simresults$Oilseed$t19), mean(list_simresults$Oilseed$t20), mean(list_simresults$Oilseed$t21),
                mean(list_simresults$Oilseed$t22)),
    Roots = c(mean(list_simresults$Roots$t1), mean(list_simresults$Roots$t2), mean(list_simresults$Roots$t3),
              ...
              mean(list_simresults$Roots$t13), mean(list_simresults$Roots$t14), mean(list_simresults$Roots$t15),
              mean(list_simresults$Roots$t16), mean(list_simresults$Roots$t17), mean(list_simresults$Roots$t18),
              mean(list_simresults$Roots$t19), mean(list_simresults$Roots$t20), mean(list_simresults$Roots$t21),
              mean(list_simresults$Roots$t22)),
    Corn = c(mean(list_simresults$Corn$t1), mean(list_simresults$Corn$t2), mean(list_simresults$Corn$t3),
                ...
                mean(list_simresults$Corn$t13), mean(list_simresults$Corn$t14), mean(list_simresults$Corn$t15),
                mean(list_simresults$Corn$t16), mean(list_simresults$Corn$t17), mean(list_simresults$Corn$t18),
                mean(list_simresults$Corn$t19), mean(list_simresults$Corn$t20), mean(list_simresults$Corn$t21),
                mean(list_simresults$Corn$t22)),
    Fertilizer = -c(mean(list_simresults$Fertilizer$t1), mean(list_simresults$Fertilizer$t2), mean(list_simresults$Fertilizer$t3),
                    ...
                    mean(list_simresults$Fertilizer$t13), mean(list_simresults$Fertilizer$t14), mean(list_simresults$Fertilizer$t15),
                    mean(list_simresults$Fertilizer$t16), mean(list_simresults$Fertilizer$t17), mean(list_simresults$Fertilizer$t18),
                    mean(list_simresults$Fertilizer$t19), mean(list_simresults$Fertilizer$t20), mean(list_simresults$Fertilizer$t21),
                    mean(list_simresults$Fertilizer$t22))
  )
    
  # Save simulation result
  save(simresults, file="rOutput/simresults_1to5_6to20.Rda")
...
#----------------------------------------------#
  ...
  # Load results
  load("rOutput/simresults_1to5_6to20.Rda")
  ...
  # Plot the results
  Fig_1to5_6to20 <- ggplot(simresults_long, aes(x=t, y=value, group=variable, shape=variable, color=variable)) +
    geom_line()+
    geom_point() +
    theme_bw() +
    ...
    annotate(geom="text", x=0.5, y=1.52, label="Drought shock",
             color="darkgrey", size=3.5)
  
  Fig_1to5_6to20
  
  # Save the plot as .png and .eps files
  ggsave("Figures/Figure_S6.2.1.png", Fig_1to5_6to20, device="png", width = 6, height = 3, units = "in", dpi=1200)
  ggsave("Figures/Figure_S6.2.1.eps", Fig_1to5_6to20, device="eps", width = 6, height = 3, units = "in", dpi=1200)
