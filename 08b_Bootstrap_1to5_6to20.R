#------------------------------------------------------#
#                                                      #
# This program estimates the model with 1to5 and 6to20 #
...
# stored in lines 915 and 930, allowing to             # 
...
#----------------------------------------#
  ...
  # ---------------------------------- #  
    ...
    list_weather <- data.frame(weather_obs=  c("gdd_obs","prec_obs","gddHigh_obs","dd_obs"),
                               ...
                               weather_6to20=c("gdd_6to20","prec_6to20","gddHigh_6to20","dd_6to20"),
                               weather_obs_1to5 = c("gdd_obs_1to5","prec_obs_1to5","gddHigh_obs_1to5","dd_obs_1to5"),
                               weather_obs_6to20 = c("gdd_obs_6to20","prec_obs_6to20","gddHigh_obs_6to20","dd_obs_6to20"),
                               weather_obs_endwith=  c("* gdd_obs)","* prec_obs)","* gddHigh_obs)","* dd_obs)"),
                               weather_1to5_endwith= c("* gdd_1to5)","* prec_1to5)","* gddHigh_1to5)","* dd_1to5)"),
                               weather_6to20_endwith=c("* gdd_6to20)","* prec_6to20)","* gddHigh_6to20)","* dd_6to20)"),
                               weather_obs_1to5_endwith = c("* gdd_obs_1to5)","* prec_obs_1to5)","* gddHigh_obs_1to5)","* dd_obs_1to5)"),
                               weather_obs_6to20_endwith = c("* gdd_obs_6to20)","* prec_obs_6to20)","* gddHigh_obs_6to20)","* dd_obs_6to20)"))
    ...
    for (i in 1:n_qcrops) { 
      ...
      for (j in 1:n_weather) {
        ...
        coef_struct_weather_obs_6to20 <- coefs_struct_crop %>% select(ends_with(list_weather[j,"weather_obs_6to20_endwith"]))
        ...
        mean_weather_6to20 <- dat_sm %>% select(list_weather[j,"weather_6to20"])
        ...
        elast_weather[j,i+1] <- PHI * (coef_struct_weather + coef_struct_weather_obs_1to5*mean_weather_1to5 + coef_struct_weather_obs_6to20*mean_weather_6to20)  * (1/mean_quantity)
        ...
        # Weather_6to20
        coef_probit_weather <- coefs_probit_crop %>% select(list_weather[j,"weather_6to20"])
        coef_struct_weather <- coefs_struct_crop %>% select(ends_with(list_weather[j,"weather_6to20_endwith"]))
        
        elast_weather_6to20 <- (PHI * (coef_struct_weather + coef_struct_weather_obs_6to20*mean_weather_obs) + phi * pred * coef_probit_weather -
                                  coef_phi_struct * linpred * coef_probit_weather * phi) * (1 / mean_quantity )
        
        # Weather_past
        elast_weather[j+4,i+1] <- elast_weather_1to5 + elast_weather_6to20
    ...
    list_weather <- data.frame(weather_obs=  c("gdd_obs","prec_obs","gddHigh_obs","dd_obs"),
                               ...
                               weather_6to20_endwith=c("_gdd_6to20","_prec_6to20","_gddHigh_6to20","_dd_6to20"),
                               weather_obs_1to5_endwith = c("_gdd_obs_1to5","_prec_obs_1to5","_gddHigh_obs_1to5","_dd_obs_1to5"),
                               weather_obs_6to20_endwith = c("_gdd_obs_6to20","_prec_obs_6to20","_gddHigh_obs_6to20","_dd_obs_6to20"))
    ...
    for (j in 1:n_weather) {
      ...
      coef_fert_weather_obs_6to20 <- coefs_fert %>% select(ends_with(list_weather[j,"weather_obs_6to20_endwith"]))
      ...
      elast_weather[j,7] <- (coef_fert_weather + coef_fert_weather_obs_1to5*mean_weather_1to5 + coef_fert_weather_obs_6to20*mean_weather_6to20) * (1/dat_sm$nx_fert)
      ...
      # Weather_6to20
      coef_fert_weather <- coefs_fert %>% select(ends_with(list_weather[j,"weather_6to20_endwith"]))
      elast_weather_6to20 <- (coef_fert_weather + coef_fert_weather_obs_6to20*mean_weather_obs) * (1/dat_sm$nx_fert)
      
      # Weather_past
      elast_weather[j+4,7] <- elast_weather_1to5 + elast_weather_6to20
    } 
...
# save actual result
save(boot_actresults, file="rOutput/bootresults_1to5_6to20_actual.Rda")
...
# save
save(boot_results, file="rOutput/bootresults_1to5_6to20.Rda")
boot_results <- NULL
...
load("rOutput/bootresults_1to5_6to20.Rda")
load("rOutput/bootresults_1to5_6to20_actual.Rda")
...
# Print
write_xlsx(tab_parprobit,"Tables/Table_S6.2.1.xlsx")
...
tab_structural$Variable <- c("Intercept", "P Cereals", "P Protein", "P Oilseed crops", "P Root crops", "P Corn", "R Fert", 
                             ...
                             "Gdd_1to5", "Prec_1to5", "GddHigh_1to5", "DD_1to5",
                             "Gdd_6to20", "Prec_6to20", "GddHigh_6to20", "DD_6to20",
                             "Gdd x Gdd_1to5", "Prec x Prec_1to5", "GddHigh x GddHigh_1to5", "DD x DD_1to5",
                             "Gdd x Gdd_6to20", "Prec x Prec_6to20", "GddHigh x GddHigh_6to20", "DD x DD_6to20",
                             "phi Cereals",
...
# Print
write_xlsx(tab_structural,"Tables/Table_S6.2.2.xlsx")
...
# Print
write_xlsx(tab_PriceElast,"Tables/Table_S6.2.3.xlsx")
...
# Print
write_xlsx(tab_WeatherElast,"Tables/Table_S6.2.4.xlsx")
