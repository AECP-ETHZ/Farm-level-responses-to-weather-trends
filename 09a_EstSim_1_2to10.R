...
# Load simulated weather
  ...
  load("rOutput/sim2018_1_2to10.Rda")
  sim2018 <- sim2018_1_2to10 
...
# Add interactions between observed and experienced weather
  ...
  sim2018$gdd_obs_1     <- sim2018$gdd_obs * sim2018$gdd_1
  sim2018$prec_obs_1    <- sim2018$prec_obs * sim2018$prec_1
  sim2018$gddHigh_obs_1 <- sim2018$gddHigh_obs * sim2018$gddHigh_1
  sim2018$dd_obs_1          <- sim2018$dd_obs * sim2018$dd_1
  
  sim2018$gdd_obs_2to10     <- sim2018$gdd_obs * sim2018$gdd_2to10
  sim2018$prec_obs_2to10    <- sim2018$prec_obs * sim2018$prec_2to10
  sim2018$gddHigh_obs_2to10 <- sim2018$gddHigh_obs * sim2018$gddHigh_2to10
  sim2018$dd_obs_2to10          <- sim2018$dd_obs * sim2018$dd_2to10
...
for (i in 1:n_crops) { 
  ...
  # Simulation
      ...
      for (t in -1:10)
      {
        ...
        # Simulate t = -1
        X$gdd_1 <- sim2018$gdd_1[sim2018$t==t]
        X$prec_1 <- sim2018$prec_1[sim2018$t==t]
        X$gddHigh_1 <- sim2018$gddHigh_1[sim2018$t==t]
        X$dd_1 <- sim2018$dd_1[sim2018$t==t]
        X$gdd_2to10 <- sim2018$gdd_2to10[sim2018$t==t]
        X$prec_2to10 <- sim2018$prec_2to10[sim2018$t==t]
        X$gddHigh_2to10 <- sim2018$gddHigh_2to10[sim2018$t==t]
        X$dd_2to10  <- sim2018$dd_2to10[sim2018$t==t]
...
# ------------------------------------ #
  ...
  for (i in 1:n_outcomes) { 
    ...
    for (t in -1:10) {
      ...
      X_sim$gdd_1 <- sim2018$gdd_1[sim2018$t==t]
      X_sim$prec_1 <- sim2018$prec_1[sim2018$t==t]
      X_sim$gddHigh_1 <- sim2018$gddHigh_1[sim2018$t==t]
      X_sim$dd_1 <- sim2018$dd_1[sim2018$t==t]
          
      X_sim$gdd_2to10 <- sim2018$gdd_2to10[sim2018$t==t]
      X_sim$prec_2to10 <- sim2018$prec_2to10[sim2018$t==t]
      X_sim$gddHigh_2to10 <- sim2018$gddHigh_2to10[sim2018$t==t]
      X_sim$dd_2to10  <- sim2018$dd_2to10[sim2018$t==t]
            
      X_sim$gdd_obs_1 <- sim2018$gdd_obs_1[sim2018$t==t]
      X_sim$prec_obs_1 <- sim2018$prec_obs_1[sim2018$t==t]
      X_sim$gddHigh_obs_1 <- sim2018$gddHigh_obs_1[sim2018$t==t]
      X_sim$dd_obs_1 <- sim2018$dd_obs_1[sim2018$t==t]
      X_sim$gdd_obs_2to10 <- sim2018$gdd_obs_2to10[sim2018$t==t]
      X_sim$prec_obs_2to10 <- sim2018$prec_obs_2to10[sim2018$t==t]
      X_sim$gddHigh_obs_2to10 <- sim2018$gddHigh_obs_2to10[sim2018$t==t]
      X_sim$dd_obs_2to10 <- sim2018$dd_obs_2to10[sim2018$t==t]
  ...
  save(simresults, file="rOutput/simresults_1_2to10.Rda")
...
#----------------------------------------------#
  ...
  # Load results
  load("rOutput/simresults_1_2to10.Rda")
  ...
  # Plot the results
  Fig_1_2to10 <- ggplot(simresults_long, aes(x=t, y=value, group=variable, shape=variable, color=variable)) +
    geom_line()+
    geom_point() +
    theme_bw() +
  ...
  ggsave("Figures/Figure_S6.3.1.png", Fig_1_2to10, device="png", width = 6, height = 3, units = "in", dpi=1200)
  ggsave("Figures/Figure_S6.3.1.eps", Fig_1_2to10, device="eps", width = 6, height = 3, units = "in", dpi=1200)
