...
# 2018-drought, for the model with 1to5 and 6to10 lags. #
#                                                       #
...
# Load simulated weather
  ...
  load("rOutput/sim2018_1to5_6to10.Rda")
  sim2018 <- sim2018_1to5_6to10
...
# Add interactions between observed and experienced weather
  ...
  sim2018$gdd_obs_6to10     <- sim2018$gdd_obs * sim2018$gdd_6to10
  sim2018$prec_obs_6to10    <- sim2018$prec_obs * sim2018$prec_6to10
  sim2018$gddHigh_obs_6to10 <- sim2018$gddHigh_obs * sim2018$gddHigh_6to10
  sim2018$dd_obs_6to10          <- sim2018$dd_obs * sim2018$dd_6to10
...
for (i in 1:n_crops) { 
  ...
  # Simulation
      ...
      for (t in -1:10)
      {
        ...
        X$gdd_6to10 <- sim2018$gdd_6to10[sim2018$t==t]
        X$prec_6to10 <- sim2018$prec_6to10[sim2018$t==t]
        X$gddHigh_6to10 <- sim2018$gddHigh_6to10[sim2018$t==t]
        X$dd_6to10  <- sim2018$dd_6to10[sim2018$t==t]
...
# ------------------------------------ #
  ...
  for (i in 1:n_outcomes) { 
    ...
    for (t in -1:10) {
      ...
      X_sim$gdd_6to10 <- sim2018$gdd_6to10[sim2018$t==t]
      X_sim$prec_6to10 <- sim2018$prec_6to10[sim2018$t==t]
      X_sim$gddHigh_6to10 <- sim2018$gddHigh_6to10[sim2018$t==t]
      X_sim$dd_6to10  <- sim2018$dd_6to10[sim2018$t==t]
      ...
      X_sim$gdd_obs_6to10 <- sim2018$gdd_obs_6to10[sim2018$t==t]
      X_sim$prec_obs_6to10 <- sim2018$prec_obs_6to10[sim2018$t==t]
      X_sim$gddHigh_obs_6to10 <- sim2018$gddHigh_obs_6to10[sim2018$t==t]
      X_sim$dd_obs_6to10 <- sim2018$dd_obs_6to10[sim2018$t==t]
  ...
  save(simresults, file="rOutput/simresults_1to5_6to10.Rda")
...
#----------------------------------------------#
  ...
  # Load results
  load("rOutput/simresults_1to5_6to10.Rda")
  ...
  # Plot the results
  Fig_1to5_6to10 <- ggplot(simresults_long, aes(x=t, y=value, group=variable, shape=variable, color=variable)) +
    geom_line()+
    geom_point() +
    theme_bw() +
  ...
  ggsave("Figures/Figure_S6.1.1.png", Fig_1to5_6to10, device="png", width = 6, height = 3, units = "in", dpi=1200)
  ggsave("Figures/Figure_S6.1.1.eps", Fig_1to5_6to10, device="eps", width = 6, height = 3, units = "in", dpi=1200)
