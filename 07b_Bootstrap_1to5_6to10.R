...
# Print
write_xlsx(tab_parprobit,path="Tables/Table_S6.1.1.xlsx")
...
tab_structural$Variable <- c("Intercept", "P Cereals", "P Protein", "P Oilseed crops", "P Root crops", "P Corn", "R Fert", 
                             ...
                             "Gdd x Gdd_6to10", "Prec x Prec_6to10", "GddHigh x GddHigh_6to10", "DD x DD_6to10",
                             "phi Cereals",
...
# Print
write_xlsx(tab_structural,path="Tables/Table_S6.1.2.xlsx")
...
# Print
write_xlsx(tab_PriceElast,path="Tables/Table_S6.1.3.xlsx")
...
# Print
write_xlsx(tab_WeatherElast,path="Tables/Table_S6.1.4.xlsx")
